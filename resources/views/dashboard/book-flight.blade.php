  ...
  <div class="row mrg-0 mrg-top-20">
    <div class="tr-single-box">
      <div class="tr-single-header">
        <h3 class="dashboard-title">Checkout Booking</h3>
      </div>
              ...
              <div class="tr-single-body">
                <form name="booking-form" method="POST">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <label>Name</label>
                      <input type="text" class="form-control" name="name" value="{{ Auth::user()->name }}" maxlength="100" readonly required>
                    </div>
                    <div class="col-sm-6">
                      <label>Email</label>
                      <input type="email" class="form-control" name="email" value="{{ Auth::user()->email }}" maxlength="100" readonly required>
                    </div>
                    <div class="col-sm-6">
                      <label>Phone</label>
                      <input type="text" class="form-control" name="phone" value="{{ Auth::user()->phone }}" maxlength="20" readonly required>
                    </div>
                    <div class="col-sm-6">
                      <label>Address</label>
                      <input type="text" class="form-control" name="address" value="{{ Auth::user()->address }}" minlength="5" maxlength="160" readonly required>
                    </div>
                    <div class="col-sm-6">
                      <label>Age</label>
                      <input type="text" class="form-control" name="age" value="{{ Auth::user()->age }}" maxlength="3" onkeypress="return onlyNumberKey(event)" readonly required>
                    </div>
                    <div class="col-sm-6">
                      <label>Gender</label>
                      <select class="wide form-control br-1" name="gender" value="{{ Auth::user()->gender }}" readonly required>
                  ...
                  <input type="hidden" name="user_id" class="single-input" value="{{ Auth::user()->id }}">
